...
export const colors = {
  text: {
    'text-primary-foreground': {
      css: { 'color': `light-dark(${tailwindColors.slate[50]}, ${tailwindColors.slate[50]})` },
      label: 'Primary Foreground',
    },
    'text-foreground': {
      css: { 'color': `light-dark(${tailwindColors.slate[950]}, ${tailwindColors.slate[50]})` },
      label: 'Foreground',
    },
    'text-muted-foreground': {
      css: { 'color': `light-dark(${tailwindColors.slate[500]}, ${tailwindColors.slate[400]})` },
      label: 'Muted Foreground',
    },
    'text-secondary-foreground': {
      css: { 'color': `light-dark(${tailwindColors.slate[900]}, ${tailwindColors.slate[50]})` },
      label: 'Secondary Foreground',
    },
    'text-accept-foreground': {
      css: { 'color': `light-dark(${tailwindColors.slate[800]}, ${tailwindColors.slate[100]})` },
      label: 'Accept Foreground',
    },
    'text-red': {
      css: { 'color': `light-dark(${tailwindColors.red[600]}, ${tailwindColors.red[500]})` },
      label: 'Red',
    },
    'text-orange': {
      css: { 'color': `light-dark(${tailwindColors.orange[600]}, ${tailwindColors.orange[500]})` },
      label: 'Orange',
    },
    'text-yellow': {
      css: { 'color': `light-dark(${tailwindColors.yellow[700]}, ${tailwindColors.yellow[500]})` },
      label: 'Yellow',
    },
    'text-green': {
      css: { 'color': `light-dark(${tailwindColors.green[700]}, ${tailwindColors.green[500]})` },
      label: 'Green',
    },
    'text-blue': {
      css: { 'color': `light-dark(${tailwindColors.blue[600]}, ${tailwindColors.blue[500]})` },
      label: 'Blue',
    },
    'text-purple': {
      css: { 'color': `light-dark(${tailwindColors.purple[600]}, ${tailwindColors.purple[500]})` },
      label: 'Purple',
    },
    'text-violet': {
      css: { 'color': `light-dark(${tailwindColors.violet[600]}, ${tailwindColors.violet[500]})` },
      label: 'Violet',
    },
    'text-slate': {
      css: { 'color': `light-dark(${tailwindColors.slate[900]}, ${tailwindColors.slate[100]})` },
      label: 'Slate',
    },
    'text-indigo': {
      css: { 'color': `light-dark(${tailwindColors.indigo[500]}, ${tailwindColors.indigo[400]})` },
      label: 'Indigo',
    },
    'text-pink': {
      css: { 'color': `light-dark(${tailwindColors.pink[600]}, ${tailwindColors.pink[400]})` },
      label: 'Pink',
    },
  ...
  underline: {
    'underline-primary-foreground': {
      css: {
        ...
        'text-decoration-color': `light-dark(${tailwindColors.slate[50]}, ${tailwindColors.slate[50]})`,
      },
      label: 'Primary Foreground',
    },
    'underline-foreground': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.slate[950]}, ${tailwindColors.slate[50]})`,
      },
      label: 'Foreground',
    },
    'underline-muted-foreground': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.slate[500]}, ${tailwindColors.slate[400]})`,
      },
      label: 'Muted Foreground',
    },
    'underline-secondary-foreground': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.slate[900]}, ${tailwindColors.slate[50]})`,
      },
      label: 'Secondary Foreground',
    },
    'underline-accept-foreground': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.slate[800]}, ${tailwindColors.slate[100]})`,
      },
      label: 'Accept Foreground',
    },
    'underline-red': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.red[600]}, ${tailwindColors.red[500]})`,
      },
      label: 'Red',
    },
    'underline-orange': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.orange[600]}, ${tailwindColors.orange[500]})`,
      },
      label: 'Orange',
    },
    'underline-yellow': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.yellow[700]}, ${tailwindColors.yellow[500]})`,
      },
      label: 'Yellow',
    },
    'underline-green': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.green[700]}, ${tailwindColors.green[500]})`,
      },
      label: 'Green',
    },
    'underline-blue': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.blue[600]}, ${tailwindColors.blue[500]})`,
      },
      label: 'Blue',
    },
    'underline-purple': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.purple[600]}, ${tailwindColors.purple[500]})`,
      },
      label: 'Purple',
    },
    'underline-violet': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.violet[600]}, ${tailwindColors.violet[500]})`,
      },
      label: 'Violet',
    },
    'underline-slate': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.slate[900]}, ${tailwindColors.slate[100]})`,
      },
      label: 'Slate',
    },
    'underline-indigo': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.indigo[500]}, ${tailwindColors.indigo[400]})`,
      },
      label: 'Indigo',
    },
    'underline-pink': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.pink[600]}, ${tailwindColors.pink[400]})`,
      },
      label: 'Pink',
    },
  } satisfies StateValues,
  background: {
    'bg-primary': {
      css: {
        'background-color': `light-dark(${tailwindColors.violet[500]}, ${tailwindColors.violet[500]})`,
        'border-radius': '3px',
      },
      label: 'Primary',
    },
    'bg-muted': {
      css: {
        'background-color': `light-dark(${tailwindColors.slate[100]}, ${tailwindColors.slate[800]})`,
        'border-radius': '3px',
      },
      label: 'Muted',
    },
